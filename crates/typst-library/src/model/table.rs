...
pub struct TableHeader {
    ...
    /// table starts; it only appears when the table continues to subsequent
    /// pages.
    ///
    ...
    /// be redundant on the first page where the table begins. Combine with a
    ...
    /// (which would otherwise trigger layout iteration / non-convergence).
    ///
