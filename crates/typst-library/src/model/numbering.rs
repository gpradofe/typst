...
pub enum NumberingKind {
    ...
    UpperGreek,
    /// Lowercase Armenian letters (ա, բ, գ, etc.).
    LowerArmenian,
    /// Uppercase Armenian letters (Ա, Բ, Գ, etc.).
    UpperArmenian,
...
impl NumberingKind {
    ...
    pub fn from_char(c: char) -> Option<Self> {
        Some(match c {
            ...
            'ա' => NumberingKind::LowerArmenian,
            'Ա' => NumberingKind::UpperArmenian,
    ...
    pub fn to_char(self) -> char {
        match self {
            ...
            Self::LowerGreek => 'α',
            Self::UpperGreek => 'Α',
            Self::LowerArmenian => 'ա',
            Self::UpperArmenian => 'Ա',
            Self::Symbol => '*',
            Self::Hebrew => 'א',
